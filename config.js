...
export const ENTITY_DATA = {
    'tree': { 
        ...
        weight: 40,
        requiredTool: 'axe', 
        textures: [{ hp: 100, src: 'tree' }, { hp: 50, src: 'tree' }] 
    },
    'stone': { 
        maxHp: 255, 
        drop: 'stone', 
...
export const GAME_SETTINGS = {
    ...
    player: { 
        ...
        colRadius: 30,
        unarmedDamage: 49 // Изменено на 49 по стандарту
    },
    greed: {
        hp: 255, // Изменено на 255 по стандарту
        colRadius: 20,
        renderRad: 30,
        damage: 8,
        attackCooldown: 60,
